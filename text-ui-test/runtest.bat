...
javac -cp ..\src\main\java -Xlint:none -d ..\bin ..\src\main\java\duke\Duke.java ..\src\main\java\duke\command\*.java ..\src\main\java\duke\common\*.java ..\src\main\java\duke\data\storage\*.java ..\src\main\java\duke\data\task\*.java ..\src\main\java\duke\data\*.java  ..\src\main\java\duke\exception\*.java ..\src\main\java\duke\parser\*.java   ..\src\main\java\duke\ui\*.java
IF ERRORLEVEL 1 (
    echo ** BUILD FAILURE **
    exit /b 1
)
